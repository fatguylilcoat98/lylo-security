...
// SAFE IMPORTS: Swapped 'risky' icons for standard ones to prevent the "Error #130" crash
import { 
  Shield, 
  Wrench, 
  Gavel, 
...
export default function ChatInterface({ 
  ...
  // State
  // FIXED: Safe initialization for activePersona
  ...
  // FIXED: Removed duplicate declaration of selectedPersonaId
