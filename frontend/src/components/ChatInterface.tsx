...
// SAFE IMPORTS: Replaced risky icons to prevent #130 Crash
import { 
...
export default function ChatInterface({ 
  ...
  // FIXED: Added missing function to fix build error
  ...
  // Safe label getter to prevent "split of undefined" crashes
  const getSafeLabel = () => {
