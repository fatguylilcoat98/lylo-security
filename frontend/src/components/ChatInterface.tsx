...
// SAFE IMPORTS: Replaced the 5 specific icons causing the Server Crash
import { 
  Shield, Wrench, Gavel, Monitor, BookOpen, 
  Smile,      // Replaces Laugh (Crash Fix)
  Coffee,     // Replaces ChefHat (Crash Fix)
  Activity, 
  Camera, Mic, MicOff, Volume2, RotateCcw, AlertTriangle, 
  Phone, CreditCard, FileText, 
  Zap,        // Replaces Brain (Crash Fix)
  Settings, LogOut, X, 
  Star,       // Replaces Crown (Crash Fix)
  ArrowLeft, Info, Play
} from 'lucide-react';
