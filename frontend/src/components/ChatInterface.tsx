...
import { sendChatMessage, getUserStats } from '../lib/api';
...
export default function ChatInterface({ 
  ...
  const loadUserStats = async () => {
    try {
      const response = await fetch(`${process.env.REACT_APP_API_URL || 'https://lylo-backend.onrender.com'}/user-stats/${userEmail}`);
      if (response.ok) {
